...
export const CANDIDATE_METRICS: readonly CandidateMetricRow[] = [
  ...
  {
    key: 'unclutchedRestCount',
    label: 'Unclutched rests',
    group: 'physics',
    value: (m) => String(m.unclutchedRestCount),
    tone: (m) => (m.unclutchedRestCount === 0 ? 'good' : 'bad'),
  },
  {
    key: 'floatingPartCount',
    label: 'Hovering parts',
    group: 'physics',
    value: (m) => String(m.floatingPartCount),
    tone: (m) => (m.floatingPartCount === 0 ? 'good' : 'bad'),
  },
  {
    key: 'stackedSeamCount',
    label: 'Stacked seams',
    group: 'physics',
    value: (m) => String(m.stackedSeamCount),
    tone: (m) => (m.stackedSeamCount === 0 ? 'good' : 'neutral'),
  },
  {
    key: 'meanExclusiveMates',
    label: 'Mean clutch',
    group: 'physics',
    value: (m) => m.meanExclusiveMates.toFixed(1),
    tone: (m) => (m.meanExclusiveMates >= 2 ? 'good' : 'neutral'),
  },
  {
    key: 'oneStudStackCount',
    label: '1×1 stacks',
    group: 'physics',
    value: (m) => String(m.oneStudStackCount),
    tone: (m) => (m.oneStudStackCount === 0 ? 'good' : 'neutral'),
  },
  {
    key: 'maxOneStudColumnHeight',
    label: 'Tallest 1×1 column',
    group: 'physics',
    value: (m) => String(m.maxOneStudColumnHeight),
    tone: (m) => (m.maxOneStudColumnHeight <= 1 ? 'good' : 'neutral'),
  },
  {
