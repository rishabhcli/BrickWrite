...
export const WORKBENCH_COMMANDS: readonly CommandDefinition[] = [
  // Tools ------------------------------------------------------------------
  {
    ...
    title: 'Select tool',
    group: 'tools',
    detail: 'Pick parts, drag to box select, drag the selection to move it.',
    defaultChord: 'v',
    keywords: 'pointer arrow pick marquee',
  },
  {
    id: 'tool.pan',
    title: 'Pan tool',
    group: 'tools',
    detail: 'Drag to slide the view. Holding Space pans from any tool.',
    defaultChord: 'alt+h',
    keywords: 'hand truck slide scroll navigate',
  },
  {
    id: 'tool.orbit',
    title: 'Orbit tool',
    group: 'tools',
    detail: 'Drag to turn the camera around the model. Middle-drag does this from any tool.',
    defaultChord: 'o',
    keywords: 'tumble turn camera navigate',
  },
  {
    id: 'tool.move',
    title: 'Move tool',
