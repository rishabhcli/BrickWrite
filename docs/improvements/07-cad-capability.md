...
**Effort:** M (XML) / L (archive round-trip).    **Risk:** BrickLink ids are exact for only 5,465 of 22,941 modelled identities — heuristic or missing ids must be surfaced in the export, not silently emitted blank.
